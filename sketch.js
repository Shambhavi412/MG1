...
function setup(){
    ...
    t1 = new JBody(150,b1.body.position.y-143,60,60,eT1);
     ...
     t2 = new JBody(380,340,60,60,eT1);
   
     b3 = new JBody(610,530,60,180,eB1);
     t3 = new JBody(610,420,60,60,eT1);
   
     b4 = new JBody(840,550,60,140,eB1);
     t4 = new JBody(840,490,60,60,eT1);
...
/**/
    ...
    player = createSprite(150,300,60,60)
    //player = new Player();
    
    exp = createSprite(100,200,100,100);
   exp.velocityX = 4;
